    ...
    <div style={{overflow: open && 'hidden'}} className='relative mt-[20px] lg:mt-[103px] '>
      ...
      <div className='absolute top-0 mt-[54px] w-full flex flex-col items-center'>
        <div className='max-w-[1090px] w-full flex flex-col items-center'>
          <p className='text-[#2B3A4C] font-semibold lg:text-[56px]'>Таны бизнессын хурдасгуур</p>
          <p className='text-[#6C7392] text-[14px] sm:text-[16px] font-medium mt-[15px] lg:mt-[30px] max-w-[532px] text-center'>Саак Ads нь хэрэглэгч төвтэй тул таны бизнессын үйл ажиллагааг илүү хүртээмжтэй хэрэглэгчидэд хүргэх юм.</p>
          <div className='flex flex-wrap justify-center gap-[20px] my-[30px] lg:my-[69px]'>
            <div className='relative h-[654px] w-[350px] bg-white rounded-[12px] flex flex-col items-center px-[28px]'>
              ...
              <button onClick={() => setOpen(1)} className='w-full h-[48px] rounded-[8px] bg-caak-primary text-white text-[16px] font-medium mt-[20px]'>
                Жишээ харах
              </button>
              <p className='text-[#2B3A4C] texrt-[15px] font-semibold mt-[25px] w-full'>Постын байршил:</p>
              ...
              <p className='w-full text-[#2B3A4C] text-[15px] font-semibold mt-[22px]'>Нэг постонд багтах зургийн тоо:</p>
              <ul className='flex flex-col w-full pl-0 text-medium text-[14px] text-[#5D636B]'>
                <ch>30ш</ch>
              </ul>
              <p className='absolute top-[-15px] bg-gradient-to-r from-[#9A99FE] to-[#3F70FE] w-[172px] h-[30px] rounded-[4px] text-white text-[15px] flex items-center justify-center'>Хамгийн эрэлттэй</p>
            </div>
            ...
            <div className='h-[654px] w-[350px] bg-white rounded-[12px] flex flex-col items-center px-[28px]'>
              ...
              <p className='text-[#2B3A4C] texrt-[15px] font-semibold mt-[25px] w-full'>Баннерын байршил:</p>
              <ul className='flex flex-col w-full pl-0 text-medium text-[14px] text-[#5D636B]'>
                <ch>
                Нүүр хуудасны голд
                </ch>
                <ch>
                Постны дэлгэрэнгүй хуудас бүрт
                </ch>
              </ul>
              <p className='w-full text-[#2B3A4C] text-[15px] font-semibold mt-[22px]'>Файлын төрөл:</p>
            ...
            <div className='h-[654px] w-[350px] bg-white rounded-[12px] flex flex-col items-center px-[28px]'>
              ...
              <ul className='flex flex-col w-full pl-0 text-medium text-[14px] text-[#5D636B]'>
                <ch>
                Нүүр хуудасны баруун талд дагана
                </ch> 
                <ch>
                Постны дэлгэрэнгүй хуудас бүрт
                </ch>
            ...
            <div className='flex flex-row w-full justify-between mt-[20px] lg:mt-[40px] px-[5px] md:px-[22px]'>
              <div>
                ...
                <p className='text-[#E60033] flex items-center font-semibold text-[16px]'><span className='icon-fi-rs-danger text-[22px] mr-[9px]'/>Анхаарах зүйлс</p>
                  <li className=' mt-[16px]'>
                  Эдгээр үнэнд НӨАТ орсон болно
                  </li>
                  <li>
                  Сурталчилгааны агуулга нь Монгол Улсын хууль журмыг зөрчөөгүй байх
                  </li>
                  <li>
                  Сурталчилгааны үнэн, бодит байдлыг захиалагч байгууллага хариуцна
                  </li>
                  <li>
              ...
              <div>
                <p className='text-[14px] md:text-[16px] font-semibold text-[#21293C] flex items-center'><span className='icon-fi-rs-phone text-[18px] mr-[10px]'/>72728008, 99093445</p>
                <p className='text-[14px] md:text-[16px] font-semibold text-[#21293C] flex items-center'><span className='icon-fi-rs-mail text-[18px] mr-[10px]'/>marketing@caak.mn</p>
              </div>
            </div>
          </div>
        </div>
