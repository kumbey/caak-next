        ...
        <div className={"flex row justify-between"}>
          ...
          <div className="flex flex-row items-center">
            ...
            >
              <span
                className={
                  "icon-fi-rs-share-o text-caak-scriptink transition duration-150 text-[15px]"
                }
              />
              <DropDown
                arrow={"bottomRight"}
            ...
            >
              <span
                className={
                  "icon-fi-rs-dots text-caak-scriptink rotate-90 transition duration-150 text-[16px]"
                }
              />
              <DropDown
                arrow={"bottomRight"}
