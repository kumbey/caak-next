      ...
      <div className="flex m-[15px]">
        ...
        <div className="flex flex-col ">
          ...
          <div className="flex mt-1 text-xs text-caak-darkBlue font-normal font-inter">
            <div className="">Кино сонирхогчид</div>
            <div className="">@undercoverosh</div>
            <div className="">24 мин</div>
          </div>
          <div className="flex mt-2">
            <div className="flex items-center mr-6">
              <span className="icon-fi-rs-rock-i text-2xl mr-2" />
              <p>23</p>
            </div>
            <div className="flex items-center mr-6">
              <span className="icon-fi-rs-comment-f text-2xl mr-2" />
              <p>14</p>
            </div>
            <div className="flex items-center mr-6">
              <span className="icon-fi-rs-share text-2xl mr-2" />
            </div>
          </div>
        </div>
      </div>
